...
(function (global) {
  ...
  dc.loadAboutRating = function () {
    showLoading("#main-content");
    $ajaxUtils.sendGetRequest(allCategoriesUrl, buildAndShowAboutHTML);
  };
  ...
  function buildAndShowAboutHTML() {
    $ajaxUtils.sendGetRequest(
      aboutHtml,
      function (aboutHtml) {
        var stars = getRandomNumberBetweenOneAndFive();
        ...
        var html = insertProperty(aboutHtml, "number", stars.toString());
        html += ` ${stars}-star Rating`;
